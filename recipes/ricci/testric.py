#  Copyright (C) 2024-2026 Steven R. Brandt, Max Morris, Lucas Timotheo Sanches, and other Einstein Engine contributors.
#
...
gf = ThornDef("TestEinsteinEngine", "Ricci", derivative_stencil_width=5)
