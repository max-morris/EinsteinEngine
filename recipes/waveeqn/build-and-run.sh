...
set +e
if [ ! -r "./TestEinsteinEngine/WaveEqn/interface.ccl" ]
then
    echo "Cannot find './TestEinsteinEngine/WaveEqn/interface.ccl" >&2
    exit 5
fi
...
echo TestEinsteinEngine/WaveEqn >> .pre_waveeqn.th
echo TestEinsteinEngine/ZeroTest >> .pre_waveeqn.th
