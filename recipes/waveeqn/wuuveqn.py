...
v_newrad = NewRadXBoundaryBatch(
	v,
	sympify(0.0),
	sympify(1.0),
	sympify(1.0),
	schedule_target=ScheduleBin.Evolve,
	schedule_after=['newwave_evo']
)

u_newrad = NewRadXBoundaryBatch(
	u,
	sympify(0.0),
	sympify(1.0),
	sympify(1.0),
...
CppCarpetXWizard(
	...
	new_rad_x_boundary_fns=[v_newrad, u_newrad]
    )
).generate_thorn()
