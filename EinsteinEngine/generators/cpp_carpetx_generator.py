...
from EinsteinEngine.generators.cactus_generator import CactusGenerator, CactusGeneratorOptions
...
class CppCarpetXGenerator(CactusGenerator):
    ...
    def generate_schedule_ccl(self) -> ScheduleRoot:
        ...
        schedule_blocks.append(ScheduleBlock(
            ...
            at_or_in=post_post_init_at_in,
            schedule_bin=post_post_init_bin,
            description=String(f'Empty function to SYNC the state vector. Syncs: {state_vec_sync_desc}. Generated by EinsteinEngine.'),
            lang=Language.C,
